 ...
 * The retired entry gives the webhook spec a published tag whose service is inactive.
 */
export const TEST_RELEASES: TestRelease[] = [
  ...
  { repository: 'retired', githubId: 930001, tagName: 'ret-v0.1.0', name: 'Retired v0.1.0' },
];
