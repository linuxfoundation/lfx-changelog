...
import { ensureChangelogsIndex } from './server/services/opensearch.service';
...
ensureChangelogsIndex().catch((err) => serverLogger.warn({ err }, 'OpenSearch index setup failed — search will be unavailable'));
